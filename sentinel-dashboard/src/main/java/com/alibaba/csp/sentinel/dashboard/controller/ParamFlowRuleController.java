...
public class ParamFlowRuleController {
    ...
    @Autowired
    private DynamicRuleApi<ParamFlowRuleEntity> ruleApi;
    @Autowired
    ...
    public Result<List<ParamFlowRuleEntity>> apiQueryAllRulesForMachine(@RequestParam String app,
        ...
        try {
            List<ParamFlowRuleEntity> rules = ruleApi.getRules(app);
...
//        return sentinelApiClient.setParamFlowRuleOfMachine(app, ip, port, rules);
        ...
        try {
            ruleApi.publish(app, rules);
        } catch (Exception e) {
            logger.error("Publish flow rules failed after rule update", e);
